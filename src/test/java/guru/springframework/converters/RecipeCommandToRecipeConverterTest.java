...
class RecipeCommandToRecipeConverterTest {
	...
	RecipeCommandToRecipeConverter recipeConverter;

	@BeforeEach
	void setUp() throws Exception {
		recipeConverter = new RecipeCommandToRecipeConverter(new CategoryCommandToCategoryConverter(),
	...
	void testConvert() {
		...
		recipeCommand.getCategoriesCommands().add(category);
		recipeCommand.getCategoriesCommands().add(category2);
		...
		recipeCommand.getIngredientsCommands().add(ingredient);
		recipeCommand.getIngredientsCommands().add(ingredient2);
